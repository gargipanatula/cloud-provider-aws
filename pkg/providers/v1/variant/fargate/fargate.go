...
func (f *fargateVariant) Initialize(cloudConfig *config.CloudConfig, credentials *stscredsv2.AssumeRoleProvider, provider config.SDKProvider, ec2API iface.EC2, region string) error {
